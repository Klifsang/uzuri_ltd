...
const Invoice = ({ ThemeStyles }) => {
  ...
  useEffect(() => {
    fetch("/api/admin/routes/clients")
      .then((response) => {
        if (!response.ok) {
  ...
  useEffect(() => {
    fetch("/api/admin/routes/drillingservices")
  ...
  useEffect(() => {
    fetch("/api/admin/routes/pumpservices")
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch("/api/admin/routes/categories")
      .then((response) => response.json())
